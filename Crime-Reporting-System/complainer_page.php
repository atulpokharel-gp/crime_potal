...
if(isset($_POST['s'])){
    ...
    if($var>=0)
    {
      ...
      $comp="INSERT into complaint(a_no,location,type_crime,d_o_c,description,inc_status,p_id) values('$a_no','$location','$type_crime','$d_o_c','$description','Assigned','102')";
...
<div style="position: relative;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>THEFT Reporting System 2020</b></h4>
</div>
