...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php"><b>THEFT Reporting System</b></a>
    </div>
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					...
					<p style="color:#dfdfdf">citizenship Number</p><input type="text"  name="aadhar_number" minlength="1" maxlength="12"  id="aadh" onfocusout="f1()"/>
